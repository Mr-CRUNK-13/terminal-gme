...
<style>
    ...
    /* MODIFICATION : Couleur de flash en Rouge Sang */
    ...
    /* NOUVEAU : Néon "Nucléaire" ROUGE SANG ultra-large pour l'image WEN */
...
# --- 3. TERMINAL ---
    ...
    def draw_live(price, prev, chart):
        ...
        diff = price - prev
        # MODIFICATION : Rouge Sang pour la baisse
        ...
        if pct >= 0:
            ...
            # MODIFICATION : Image WEN avec Néon Nucléaire ROUGE SANG élargi
    ...
    with tab3:
        ...
        # MODIFICATION : Couleurs EU avec Rouge Sang (#FF0000)
        ...
        for i, k in enumerate(["XET", "NSY", "Warrant", "TDG"]):
            ...
            # Utilisation de Rouge Sang ici aussi
    ...
    with tab4:
        ...
        # MODIFICATION : Rouge Sang pour les textes de baisse US
